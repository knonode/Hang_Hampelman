# with open("bip39.txt", "r") as file:
#   # Read the words and strip any leading or trailing whitespace
#   words = [word.strip() for word in file.readlines()]

# # Convert the list of words into a list of strings
# string_list = [f"{word}" for word in words]

# # Output the resulting list of strings
# print(string_list)

bip_39 = ['abandon', 'ability', 'able', 'about', 'above', 'absent', 'absorb', 'abstract', 'absurd', 'abuse', 'access',
          ...
          'cigar', 'cinnamon', 'circle', 'citizen', 'city', 'civil', 'claim', 'clap', 'clarify', 'claw', 'clay',
